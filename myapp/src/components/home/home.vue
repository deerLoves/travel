    ...
    <div class="page home">
        <div id="search">
            ...
            <div class="searchaddress">
                <p>北京</p><i class="iconfont icon-ico_arrows_unfold"></i>
            </div>
        </div>
        <div id="find">
            <h2>发现行漫</h2>
...
#search>.searchspot{
    ...
    box-shadow: 0 0.02rem 0.02rem 0 rgba(0,0,0,0.50);
...
#find>h2,#hotspot>h2,#hottrip>h2,#hotstory>h2{
    font-family: PingFangSC-Regular;
    font-size: 52px;
    color: #030303;
    letter-spacing: -0.003rem;
...
#hotspot>.banner,#hottrip>.banner{
    display: flex;
    overflow:scroll;
    padding:0.48rem 0 0.36rem;
}
#hotspot>.banner>dl,#hottrip>.banner>dl{
    padding:0 0 0.1rem 0.32rem;
}
#hotspot>.banner>dl>dt>img,#hottrip>.banner>dl>dt>img{
    width: 4.02rem;
    height: 2.04rem;
    border-radius: 0.2rem 0.2rem 0 0;
}
#hotspot>.banner>dl>dd:nth-of-type(1)>p,#hottrip>.banner>dl>dd:nth-of-type(1)>p{
    width: 3.78rem;
...
#hotspot>.banner>dl>dd:nth-of-type(1),#hottrip>.banner>dl>dd:nth-of-type(1){
    height: 0.8rem;
    display: -webkit-box;
...
#hotspot>.banner>dl>dd:nth-of-type(1)>p>span,#hottrip>.banner>dl>dd:nth-of-type(1)>p>span{
    color: #C90000;
}
#hotspot>.banner>dl>dd:nth-of-type(2)>p,#hottrip>.banner>dl>dd:nth-of-type(2)>p{
    font-family: PingFangSC-Regular;
    font-size: 36px;
    color: #D94A4A;
